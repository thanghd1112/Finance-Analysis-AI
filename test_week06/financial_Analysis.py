...
class AIAgent:
    ...
    def predict_future_price(self, ticker, days=30, seasonality_mode='additive'):
        ...
        try:
            ...
            # Sử dụng StockPredictor để dự đoán với chế độ seasonality được chọn
            plt_predict, future_prices = self.predictor.predict(price_data, days=days, seasonality_mode=seasonality_mode)
